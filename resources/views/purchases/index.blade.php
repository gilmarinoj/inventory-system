        ...
        <div class="card card-outline card-primary mb-3">
            <div class="card-header">
                <div class="text-left mb-4  ">
                    <h3 class="card-title float-right mb">
                        <i class="fas fa-filter"></i> {{ __('Filters') }}
                    </h3>
                    <form action="{{ route('purchases.report.pdf') }}" method="GET" target="_blank" class="d-inline">
                        <div class="row g-2 align-items-end">
                            <div class="col-auto">
                                <label class="form-label mb-1"><small>Desde</small></label>
                                <input type="date" name="start_date" class="form-control" required
                                    value="{{ old('start_date', now()->subDays(30)->format('Y-m-d')) }}">
                            </div>
                            <div class="col-auto">
                                <label class="form-label mb-1"><small>Hasta</small></label>
                                <input type="date" name="end_date" class="form-control" required
                                    value="{{ old('end_date', now()->format('Y-m-d')) }}">
                            </div>
                            <div class="col-auto">
                                <button type="submit" class="btn btn-success ">
                                    <i class="fas fa-file-pdf"></i> Generar PDF de Compras
                                </button>
                            </div>
                        </div>
                    </form>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <div class="mb-3">
                                                    <strong class="text-success">
                                                        $ <span
                                                            x-text="parseFloat(purchase.total_amount).toFixed(2)"></span>
                                                    </strong>
                                                    <br>
